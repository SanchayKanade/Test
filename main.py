...
def draw_count(img):
    cv2.putText(img, 'UP', (16,16), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,255), 2)
    cv2.putText(img, 'V Light: ' + str(count[vehicle.V_LIGHT_VEHICLE][vehicle.DIR_UP]), (16,41), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,255), 2)
    cv2.putText(img, 'Light  : ' + str(count[vehicle.LIGHT_VEHICLE][vehicle.DIR_UP]), (16,66), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,255), 2)
    cv2.putText(img, 'Heavy  : ' + str(count[vehicle.HEAVY_VEHICLE][vehicle.DIR_UP]), (16,91), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,255), 2)

    cv2.putText(img, 'DOWN', (200,16), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,255), 2)
    cv2.putText(img, 'V Light: ' + str(count[vehicle.V_LIGHT_VEHICLE][vehicle.DIR_DOWN]), (200,41), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,255), 2)
    cv2.putText(img, 'Light  : ' + str(count[vehicle.LIGHT_VEHICLE][vehicle.DIR_DOWN]), (200,66), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,255), 2)
    cv2.putText(img, 'Heavy  : ' + str(count[vehicle.HEAVY_VEHICLE][vehicle.DIR_DOWN]), (200,91), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,255), 2)
...
output = cv2.VideoWriter('output/vid2.avi',fourcc, 20.0, (frame.shape[1],frame.shape[0]))
...
while ret:
    ...
    for i in indices:
        ...
        w = box[2]
        h = box[3]
        if not(w <= 1.5 * vehicle.MARGINS or h <= 1.5 * vehicle.MARGINS):
